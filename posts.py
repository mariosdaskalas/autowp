...
def run(playwright: Playwright) -> None:
    ...
    page.goto(f"{target}/wp-admin/post-new.php")
    ...
    page.get_by_role("tab", name="Post").click()
    page.get_by_label("Editor settings").get_by_role("heading", name="No Title").click()
    page.get_by_label("Editor settings").click()
    ...
    page.get_by_label("Editor publish").get_by_role("link", name="View Post").click()
    #time.sleep(2)
